...
import { KLManga } from '../KLManga/KLManga'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('KLManga Tests', () => {
  const wrapper: APIWrapper = new APIWrapper()
  const source: Source = new KLManga(cheerio)
   ...
   */
  const mangaId = 'zzga-kimetsu-no-yaiba-raw.html' // Demon slayer
